...
*}
<div id="idTab5" class="contenedorComentario">
	<div id="product_comments_block_tab" class="contenedorInternoComentario">
		{if $comments}
			{foreach from=$comments item=comment}
				...
				<div class="comentario" itemprop="review" itemscope itemtype="http://schema.org/Review">
					...
					<div class="detalleComentario">
						<p itemprop="name" class="comentarioTitulo">
							<strong>{$comment.title} </strong>
							{$comment.content|escape:'html':'UTF-8'|nl2br}
						</p>
						<!-- <p itemprop="reviewBody" class="comentarioFinal">{$comment.content|escape:'html':'UTF-8'|nl2br}</p> -->
						...
						<ul>
							...
							{if $is_logged}
								...
								<li>
									...
									<button class="like" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
										<span>{l s='Yes' mod='productcomments'}</span>
									</button>
									<button class="nolike" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
