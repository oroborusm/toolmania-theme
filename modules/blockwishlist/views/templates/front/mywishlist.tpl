...
<div id="mywishlist" class="mywishlist">
	...
	{if $id_customer|intval neq 0}
		...
		{if $wishlists}
			<div id="block-history" class="block-center" style="margin-top:16px;">
					...
					<tbody class="bodyWishlist">
						{section name=i loop=$wishlists}
							<tr id="wishlist_{$wishlists[i].id_wishlist|intval}">
								...
								<td class="wishlist_delete cart_delete text-center">
									<div>
										<a 
	...
	{/if}
		...
		<p class="navegador">
			<a class="volverCompra" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
				<span>{l s='Back to Your Account' mod='blockwishlist'}</span>
				<i class="icon-chevron-left"></i>
			</a>

			<a class="checkout" href="{$base_dir|escape:'html':'UTF-8'}">
				<span>
